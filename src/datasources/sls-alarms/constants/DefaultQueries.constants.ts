...
import { DEFAULT_QUERY_EDITOR_DESCENDING, DEFAULT_QUERY_EDITOR_SEVERITY_LEVEL_FORMAT, DEFAULT_QUERY_EDITOR_TAKE, DEFAULT_QUERY_EDITOR_TRANSITION_INCLUSION_OPTION } from './AlarmsQueryEditor.constants';
...
export const defaultListAlarmsQuery: Omit<ListAlarmsQuery, 'refId'> = {
  ...
  severityLevelFormat: DEFAULT_QUERY_EDITOR_SEVERITY_LEVEL_FORMAT,
};
